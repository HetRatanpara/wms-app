                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).displayValue != null) {
                                ...
                                if (intentData.length() > 0) {
                                    ...
                                    intent.putExtra("product_name",intentData);
                                    setResult(RESULT_OK,intent);
                                    finish();
                                    //startActivity(new Intent(BarcodeActivity.this, ProductFragment.class).putExtra("email_address", intentData));
                                }else{
                                    Toast.makeText(BarcodeActivity.this, "Try Again....", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    });
