...
public class ScanNfcBottomSheet1 extends BottomSheetDialogFragment {
    ...
    public ScanNfcBottomSheet1(NfcScanListener nfcScanListener) {
        this.nfcScanListener = nfcScanListener;
    }

    public ScanNfcBottomSheet1(NfcScanListener nfcScanListener, boolean isFromSchedule) {
        this.nfcScanListener = nfcScanListener;
...
//            FirebaseAnalytics.getInstance(getContext()).setCurrentScreen(getActivity(), "task_nfc_scan_dialog_app_screen", ScanNfcBottomSheet.class.getSimpleName());
        }
    }
